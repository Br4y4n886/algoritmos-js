...
let nombre = 'brayan';  //declaramos el inicio de la variable nombre
let edad = 18;
let mayorEdad = true;
...
switch (dia) {
    ...
    case 'sabado':
        ...
        break
    case 'domingo':
        console.log('parchese que mañana al mismo problema por mucho tiempo de tu vidaD:');

    default:
        console.log('No es un dia de la semana, claremente')
        break;
}
